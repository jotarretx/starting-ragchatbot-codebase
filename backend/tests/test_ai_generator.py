...
class TestAIGenerator:
    ...
    def setup_method(self):
        ...
        self.ai_generator = AIGenerator(
            base_url="http://localhost:11434", model="mistral:7b", max_rounds=2
        )
    ...
    def test_generate_response_without_tools(self):
        ...
        mock_response = {
            "message": {"content": "This is a general knowledge response."}
        }
    ...
    def test_single_round_with_tools_no_tool_calls(self):
        ...
        mock_response = {
            "message": {"content": "This is a direct answer without using tools."}
        }
        self.mock_client.chat.return_value = mock_response
    ...
    def test_single_round_with_one_tool_call(self):
        ...
        self.mock_tool_manager.execute_tool.return_value = (
            "Search result: ML is a subset of AI..."
        )
    ...
    def test_max_rounds_termination(self):
        ...
        # Mock final response
        mock_final_response = {
            "message": {"content": "Final response after max rounds reached"}
        }
    ...
    def test_tool_execution_error_handling(self):
        ...
        mock_response_round2 = {
            "message": {"content": "I'll provide what I can despite the error."}
        }

        # Mock final synthesis response
        mock_final_response = {"message": {"content": "Response despite tool error"}}
    ...
    def test_conversation_history_preservation(self):
        ...
        # Mock response
        mock_response = {"message": {"content": "Response with history context"}}
        self.mock_client.chat.return_value = mock_response
...
class TestAIGeneratorIntegration:
    ...
    def test_complex_multi_round_scenario(self):
        ...
        assert (
            result
            == "Based on the search, Course Y also covers machine learning algorithms similar to lesson 4 of Course X."
        )
        assert self.mock_client.chat.call_count == 3
        assert self.mock_tool_manager.execute_tool.call_count == 2
